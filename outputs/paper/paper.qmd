...
bp <- barplot(conting_table,
              xlab = "Year",
              ylab = "# of Occurances",
              main = "Change in Type of Crisis Calls Attended from 2014 to 2024",
              beside = TRUE,
              ylim = c(0, 23000),
